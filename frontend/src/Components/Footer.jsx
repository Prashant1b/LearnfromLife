...
function Footer() {
  return (
    <footer className="footer footer-horizontal footer-center bg-gray-900 text-gray-300  p-10 border-t border-gray-800">
      {/* Navigation Links */}
      <nav className="grid grid-flow-col gap-6 text-sm md:text-base">
        ...
        <Link to="/condition" className="hover:text-blue-400 transition-colors duration-200">
          Privacy Policy
        </Link>
      </nav>
          ...
          <a href="#" className="hover:text-blue-400 transition-colors duration-200">
            ...
            >
              <path d="M24 4.557c-.883.392-1.832.656-2.828.775 1.017-.609 1.798-1.574 
                ...
                4.89-.693.188-1.452.232-2.224.084.626 
                1.956 2.444 3.379 4.6 
                3.419-2.07 1.623-4.678 2.348-7.29 
                2.04 2.179 1.397 4.768 2.212 
          ...
          <a href="#" className="hover:text-blue-400 transition-colors duration-200">
            ...
            >
              <path d="M19.615 3.184c-3.604-.246-11.631-.245-15.23 
                ...
                8.816.029 6.185.484 8.549 
                4.385 8.816 3.6.245 11.626.246 
                15.23 0 3.897-.266 4.356-2.62 
                4.385-8.816-.029-6.185-.484-8.549
                -4.385-8.816zm-10.615 
      ...
      {/* Copyright */}
      <aside className="mt-5 text-gray-500 text-sm">
        <p>
          Copyright © {new Date().getFullYear()} — All rights reserved by{" "}
          <span className="text-blue-400 font-semibold">PB Group</span>
        </p>
      </aside>
    </footer>
  );
